...
// External types - will be moved to protocol in Step 4
import type { TChatConversation, IProvider, IMcpServer, ICssTheme, TProviderWithModel } from '@/common/config/storage'
import type { IConfirmation } from '@/common/chat/chatLib'
import type { SlashCommandItem } from '@/common/chat/slash/types'
import type { AcpBackend, AcpBackendAll, AcpModelInfo, PresetAgentType } from '@/common/types/acpTypes'
import type { AcpSessionConfigOption } from '@/common/types/acpTypes'
import type { PreviewHistoryTarget, PreviewSnapshotInfo, PreviewContentType } from '@/common/types/preview'
import type {
  UpdateCheckRequest,
  UpdateCheckResult,
...
import type { SpeechToTextRequest, SpeechToTextResult } from '@/common/types/speech'
import type { DocumentConversionRequest, DocumentConversionResponse } from '@/common/types/conversion'
import type { IMessageSearchResponse } from '@/common/types/database'
import type {
  SnapshotInfo,
  CompareResult,
  FileChangeOperation,
} from '@/common/types/fileSnapshot'
...
export type EndpointMap = {
  ...
  'read-skill-info': { request: { skillPath: string }; response: IBridgeResponse<{ name: string; description: string }> }
  ...
  'detect-and-count-external-skills': {
    request: void
    response: IBridgeResponse<
      Array<{ name: string; path: string; source: string; skills: Array<{ name: string; description: string; path: string }> }>
    >
  }
  ...
  'mcp.sync-to-agents': {
    ...
    response: IBridgeResponse<{ success: boolean; results: Array<{ agent: string; success: boolean; error?: string }> }>
  }
  ...
  'database.get-conversation-messages': {
    ...
    response: import('@/common/chat/chatLib').TMessage[]
  }
  ...
  'webui.start': {
    ...
    response: IBridgeResponse<{ port: number; localUrl: string; networkUrl?: string; lanIP?: string; initialPassword?: string }>
  }
