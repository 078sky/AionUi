...
export type I18nKey =
  ...
  | 'acp.auth.requiredHint'
  | 'acp.config.default'
  | 'acp.config.reasoning_effort'
  | 'acp.connection.disconnectedHint'
  | 'acp.connection.retryFailed'
  | 'acp.logs.authFailed'
  | 'acp.logs.authReady'
  | 'acp.logs.authRequested'
  | 'acp.logs.cancelRequested'
  | 'acp.logs.disconnectReason'
  | 'acp.logs.firstResponse'
  | 'acp.logs.requestErrored'
  | 'acp.logs.requestFinished'
  | 'acp.logs.requestStarted'
  | 'acp.logs.retryFailed'
  | 'acp.logs.retryReady'
  | 'acp.logs.retryRequested'
  | 'acp.logs.sendFailed'
  | 'acp.logs.sendNowRequested'
  | 'acp.logs.title'
  | 'acp.send.failed'
  | 'acp.sendbox.placeholder'
  | 'acp.status.auth_required'
