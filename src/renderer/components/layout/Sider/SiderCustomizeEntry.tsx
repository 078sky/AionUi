...
/**
 * Sidebar entry for the Customize panel (Skills & Tools browser).
 * Follows the same pattern as SiderProjectsEntry.
 */
...
interface SiderCustomizeEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderCustomizeEntry: React.FC<SiderCustomizeEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  const label = t('customize.pageTitle', { defaultValue: 'Customize' });
...
export default SiderCustomizeEntry;
